...
function Services() {
    return (
        <div name="service" className='bg-[#0a192f] w-full overflow-x-hidden'>
            ...
            <h3 className='text-7xl text-white flex justify-center items-center mt-36 underline mb-12 font-bold'>Services Provided</h3>
            ...
            <div className='mt-24 flex flex-col md:flex-row gap-12 max-w-[1000px] mx-auto items-center'>
                ...
                <div className='sm:px-10 mx-auto flex flex-col gap-6'>
                    <h3 className='text-[#de909e] text-5xl font-bold'>Data Pipeline</h3>
            ...
            <div className='mt-24 flex flex-col md:flex-row gap-12 max-w-[1000px] mx-auto items-center'>
                ...
                {/* description */}
                <div className='sm:px-10 mx-auto flex flex-col gap-6'>
                    <h3 className='text-[#de909e] text-5xl font-bold'>Machine Learning Mastery</h3>
            ...
            <div className='mt-24 flex flex-col md:flex-row gap-12 max-w-[1000px] mx-auto items-center'>
                ...
                {/* description */}
                <div className='sm:px-10 mx-auto flex flex-col gap-6'>
                    <h3 className='text-[#de909e] text-5xl font-bold'>Real-time Data Intelligence</h3>
            ...
            <div className='mt-24 flex flex-col md:flex-row gap-12 max-w-[1000px] mx-auto items-center'>
                ...
                {/* description */}
                <div className='sm:px-10 mx-auto flex flex-col gap-6'>
                    <h3 className='text-[#de909e] text-5xl font-bold'>MLOps Excellence</h3>
            ...
            <div className='mt-24 flex flex-col md:flex-row gap-12 max-w-[1000px] mx-auto items-center'>
                ...
                {/* description */}
                <div className='sm:px-10 mx-auto flex flex-col gap-6'>
                    <h3 className='text-[#de909e] text-5xl font-bold'>Natural Language Processing (NLP)</h3>
                    <p className='text-white text-xl'>Instant Insights, Timely Actions: In today's fast-paced world, real-time insights are crucial for effective decision-making. Our real-time data intelligence solutions provide you with instant access to actionable insights as data flows in. From real-time dashboards to automated alerts, you can respond promptly to changing scenarios, seize opportunities, and mitigate risks.</p>
                </div>
            </div>
            ...
            <div className='mt-24 flex flex-col md:flex-row gap-12 max-w-[1000px] mx-auto items-center'>
                ...
                {/* description */}
                <div className='sm:px-10 mx-auto flex flex-col gap-6'>
                    <h3 className='text-[#de909e] text-5xl font-bold'>Recommendation Systems</h3>
            ...
            <h3 className='text-7xl text-white flex justify-center items-center mt-36 underline mb-12 font-bold'>Data Engineering Services</h3>
            ...
            <div className='mt-24 flex flex-col md:flex-row gap-12 max-w-[1000px] mx-auto items-center'>
                ...
                {/* description */}
                <div className='sm:px-10 mx-auto flex flex-col gap-6'>
                    <h3 className='text-[#de909e] text-5xl font-bold'>Web-Scale Automation</h3>
            ...
            <div className='mt-24 flex flex-col md:flex-row gap-12 max-w-[1000px] mx-auto items-center'>
                ...
                {/* description */}
                <div className='sm:px-10 mx-auto flex flex-col gap-6'>
                    <h3 className='text-[#de909e] text-5xl font-bold'>Security & Governance</h3>
            ...
            <div className='mt-24 flex flex-col md:flex-row gap-12 max-w-[1000px] mx-auto items-center'>
                ...
                {/* description */}
                <div className='sm:px-10 mx-auto flex flex-col gap-6'>
                    <h3 className='text-[#de909e] text-5xl font-bold'>Cloud Integration</h3>
            ...
            <div className='mt-24 flex flex-col md:flex-row gap-12 max-w-[1000px] mx-auto items-center'>
                ...
                {/* description */}
                <div className='sm:px-10 mx-auto flex flex-col gap-6'>
                    <h3 className='text-[#de909e] text-5xl font-bold'>ETL Expertise</h3>
            ...
            <div className='mt-24 flex flex-col md:flex-row gap-12 max-w-[1000px] mx-auto items-center'>
                ...
                {/* description */}
                <div className='sm:px-10 mx-auto flex flex-col gap-6'>
                    <h3 className='text-[#de909e] text-5xl font-bold'>Data Quality Management</h3>
