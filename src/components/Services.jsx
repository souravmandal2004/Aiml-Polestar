        ...
        <div name="service" className='bg-[#0a192f] w-full overflow-hidden'>
            ...
            <div className='mt-24 flex flex-col md:flex-row gap-12 max-w-[1000px] mx-auto items-center'>
                ...
                <div className='sm:px-10 mx-auto flex flex-col gap-6 md:w-[80%]'>
                    ...
                    <p className='text-white text-xl p-3'>Personalized Experiences: Enhance customer experiences and engagement through personalized recommendations. Our recommendation systems analyze user behavior to suggest products, content, or services tailored to individual preferences. By delivering relevant offerings, you deepen customer loyalty and drive conversions.</p>
                </div>
            </div>
