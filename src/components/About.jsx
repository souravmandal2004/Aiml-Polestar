...
import ourMission from "../assets/ourMissionImage.avif";
            ...
            <div className='mt-36 max-w-[1000px] mx-auto'>
                ...
                <div className='grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6'>
                    ...
                    <div className=''>
                        ...
                        <p className='text-white mt-8 font-semibold text-xl'>Creative Solution</p>
                    </div>
                    {/* second value  */}
                    <div className=''>
                        <img src={secondValue} alt="first value" loading='lazy' className='rounded-full' />
                        <p className='text-white mt-8 font-semibold text-xl'>People First</p>
                    </div>
                    {/* third value  */}
                    <div className=''>
                        <img src={thirdValue} alt="first value" loading='lazy' className='rounded-full' />
                        <p className='text-white mt-8 font-semibold text-xl'>Collaboration</p>
                    </div>
                    {/* fourth value  */}
                    <div className=''>
                        <img src={fourthValue} alt="first value" loading='lazy' className='rounded-full' />
                        <p className='text-white mt-8 font-semibold text-xl'>Transparency</p>
                    </div>
                </div>
            </div>
